...
if __name__ == "__main__":
    ...
    db.add(Commodity(id=1, name='FLAG', desc='I wanna go home with you !', price=5201314.0))
    db.add(Commodity(id=2, name='SECRET', desc='hush..this comes from the black market !', price=700.0, secret='http://ip:port/qwajsdfxjafioshqrwpieuz'))
    db.add(Commodity(id=3, name='HINT', desc='maybe you need it', price=700.0, secret='/app/flag'))
    for i in xrange(4, 49):
